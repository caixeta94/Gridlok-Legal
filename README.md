...
Documentos legais de **Gridlok** (`com.uaigames.gridlok`) — publicados via GitHub Pages.
...
2. A URL fica `https://caixeta94.github.io/Gridlok-Legal/`

## URLs para a ficha da Play Store

| Campo do Play Console | URL |
|---|---|
| Política de Privacidade | `https://caixeta94.github.io/Gridlok-Legal/privacidade.html` |
| Exclusão de conta (Data safety) | `https://caixeta94.github.io/Gridlok-Legal/exclusao-de-conta.html` |
| Site do desenvolvedor | `https://caixeta94.github.io/Gridlok-Legal/` |
